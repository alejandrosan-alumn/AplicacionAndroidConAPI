...
public class SeriesDetalles {
    ...
    @Expose
    private List<GenreSeries> genres = null;
    ...
    @Expose
    private List<ProductionCompanySeries> productionCompanies = null;
     ...
     * @param status
     */
    public SeriesDetalles(String backdropPath, List<CreatedBy> createdBy, List<Integer> episodeRunTime, String firstAirDate, List<GenreSeries> genres, String homepage, Integer id, Boolean inProduction, List<String> languages, String lastAirDate, LastEpisodeToAir lastEpisodeToAir, String name, Object nextEpisodeToAir, List<Network> networks, Integer numberOfEpisodes, Integer numberOfSeasons, List<String> originCountry, String originalLanguage, String originalName, String overview, Double popularity, String posterPath, List<ProductionCompanySeries> productionCompanies, List<Object> productionCountries, List<Season> seasons, List<SpokenLanguage> spokenLanguages, String status, String tagline, String type, Double voteAverage, Integer voteCount) {
        super();
    ...
    public void setGenres(List<GenreSeries> genres) {
        this.genres = genres;
    }
    ...
    public List<ProductionCompanySeries> getProductionCompanies() {
        return productionCompanies;
    }

    public void setProductionCompanies(List<ProductionCompanySeries> productionCompanies) {
        this.productionCompanies = productionCompanies;
    }
